...
I built a terminal-based number guessing game using Bash scripting, PostgreSQL,
and Git, all running in a virtual Linux environment. I set up the development
environment by installing Docker Engine, VS Code with Dev Containers, and Git. 
